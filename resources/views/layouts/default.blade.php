...
<body>
    ...
    {{-- Always use landingpage header for all pages --}}
    @include('components.home_made_by_developer.header')

    <section style="padding-top: 80px; padding-bottom: 60px;">
        @yield('content')
    </section>
    
    {{-- Always use landingpage footer for all pages --}}
