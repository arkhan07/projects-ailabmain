                                                            ...
                                                            <h4>
                                                                ...
                                                                @else
                                                                    @if ($course->discount_flag == 1)
                                                                        ...
                                                                        @endphp
                                                                        <b class="text-dark">{{ currency($course->discounted_price) }}</b>
                                                                        <del class="text-12px">{{ currency($course->price) }}</del>
                                                                    @else
                                                                        @php
                                                                            $count_items_price += $course->price;
                                                                        @endphp
                                                                        <b class="text-dark">{{ currency($course->price) }}</b>
                                                                    @endif
                                                                @endif
                                                            </h4>
                                                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="cart-total-price px-0 px-lg-4">
                            ...
                            <h4 class="price_type sub_total mb-4">
                                ...
                                <span>{{ currency($count_items_price) }}</span>
                            </h4>
                            ...
                            @if ($discount)
                                <h4 class="price_type tax mb-4">
                                    ...
                                    <span>- {{ currency($coupon_discount) }}</span>
                                </h4>
                            @endif
