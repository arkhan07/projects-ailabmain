                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dAdmin_info_name min-w-150px text-end">
                                        <p>
                                            {{ get_phrase('-') }}
                                            {{ currency($payment_details['custom_field']['coupon_discount']) }}
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dAdmin_info_name min-w-150px text-end">
                                        <p>
                                            {{ get_phrase('+') }}
                                            {{ currency($payment_details['custom_field']['unique_code']) }}
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <td>
                                <div class="dAdmin_info_name min-w-150px text-end">
                                    <p><span>{{ get_phrase('Grand Total') }}:
                                            {{ currency($payment_details['payable_amount']) }}</span>
                                    </p>
                                </div>
                            </td>
                        </tr>
