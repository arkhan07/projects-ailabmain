    ...
    <div class="header-content-right d-flex align-items-center justify-content-end">
        ...
        <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Help Center') }}">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a href="https://jagosoftware.my.id/docs/lms" target="_blank" class="dropdown-item">
                ...
                <li>
                    <a href="https://jagosoftware.my.id" target="_blank" class="dropdown-item">
                ...
                <li>
                    <a href="https://jagosoftware.my.id" target="_blank" class="select-text text-capitalize">
                        <i class="fi-rr-add"></i>
                        <span>{{ get_phrase('Request a new feature') }}</span>
                    </a>
                </li>
                <li>
                    <a href="https://jagosoftware.my.id" target="_blank" class="text-premium select-text text-capitalize d-flex align-items-center">
