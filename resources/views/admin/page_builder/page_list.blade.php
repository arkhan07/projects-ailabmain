                    ...
                    <table class="table eTable table-hover">
                        ...
                        @foreach (App\Models\Builder_page::get() as $key => $page)
                            <tr>
                                ...
                                <td>
                                    @if (strtolower($page->name) == '1001 pioneer ai landing')
                                        <a class="btn ol-btn-outline-secondary ol-btn-sm"
                                            ...
                                            href="#" class="btn text-secondary">{{ get_phrase('Edit Beranda') }}</a>
                                    @elseif ($page->is_permanent == 0)
