...
<footer class="footer">
    <div class="footer-container">
        <p class="copyright">
            © {{ date('Y') }} <a href="{{ get_settings('footer_link') }}" target="_blank" rel="noopener noreferrer">{{ get_settings('footer_text') }}</a>, {{ get_phrase('All rights reserved') }}
        </p>
        <nav class="footer-nav" aria-label="Footer navigation">
            <a href="{{ route('privacy.policy') }}">{{ get_phrase('Privacy Policy') }}</a>
            <a href="{{ route('terms.condition') }}">{{ get_phrase('Term of Use') }}</a>
        </nav>
    </div>
</footer>
